...
- Name: frontend\e2e\chat-panel.spec.ts >> PR投稿エージェント >> generates a live-post draft after selecting a scene and uploading a photo
- Location: frontend\e2e\chat-panel.spec.ts:36:7
